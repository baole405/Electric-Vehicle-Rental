  ...
  return (
    ...
    >
      {activeSection === 'overview' && (
        <div className="space-y-6 pt-6">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {/* Brand Management Quick Access - Admin Only */}
            {isAdmin && (
              <Card className="flex flex-col border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-blue-700">
                        Thêm, sửa, xóa thương hiệu xe điện
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {/* Staff Brand View - Staff Only */}
            {isStaff && !isAdmin && (
              <Card className="flex flex-col border-green-200 bg-gradient-to-br from-green-50 to-emerald-50">
                <div className="border-b border-green-200 bg-green-100/50 px-6 py-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-green-700">
                        Xem thông tin các thương hiệu (chỉ đọc)
                      </p>
                    </div>
                  </div>
                </div>
      ...
      {activeSection === 'brands' && (
        <div className="pt-6">
          {isAdmin ? <AdminBrandManagement /> : <StaffBrandView />}
        </div>
      )}
    </DashboardLayout>
  );
